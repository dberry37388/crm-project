...
import TeamDealsComboBox from "../TeamDealsComboBox";
...
const saveForm = () => {
    ...
    form.post(props.modelRoute + '/' + form.deal.id, {
            errorBag: 'attachDeal',
            preserveScroll: true,
...
<template>
    <SlideoverWithTitle :show="show">
        ...
        <template #content>
            <div class="pt-6 pb-5">
                <div>
                    Use the tool below to associate this resource with an existing deal.
                </div>
            </div>

            <div class="mt-5">
                <TeamDealsComboBox v-model="form.deal" />
            </div>
        </template>
